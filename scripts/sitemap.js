...
Sitemap: https://material-ui-arc-teal.vercel.app/sitemap_local.xml
Disallow:`;
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ${Object.keys(pathsObj)
    ...
    ${
      path === "/index"
        ? `<loc>https://material-ui-arc-teal.vercel.app</loc>`
        : `<loc>https://material-ui-arc-teal.vercel.app${path}</loc>`
    }
    <lastmod>${
